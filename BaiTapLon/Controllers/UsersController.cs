...
namespace BaiTapLon.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            // Thay thế các giá trị sau đây bằng thông tin cấu hình email của bạn
            string smtpServer = "smtp.gmail.com";
            int smtpPort = 587; // Port thường là 587 hoặc 465 cho SSL
            string smtpUsername = "nhasachdt123@gmail.com";
            string smtpPassword = "gjkzcvcoieogpfhm";

            MailMessage message = new MailMessage();
            message.From = new MailAddress(smtpUsername);
            message.To.Add(new MailAddress(emailAddress));
            message.Subject = "Xác nhận đăng ký tài khoản";
            message.Body = "Cảm ơn bạn đã đăng ký tài khoản. Chúng tôi đã nhận được thông tin đăng ký của bạn.";

            SmtpClient client = new SmtpClient(smtpServer, smtpPort);
            client.Credentials = new NetworkCredential(smtpUsername, smtpPassword);
            client.EnableSsl = true; // Bật SSL nếu cần
            ...
            {
                // Xử lý lỗi gửi email
                // Ví dụ: Log lỗi hoặc hiển thị thông báo cho người dùng
